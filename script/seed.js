...
async function seed() {
  ...
  const prompts = await Promise.all([
    Prompt.create({
      title: "Music",
      key: "Music is an important part of any festival. I mean, who doesn’t want to hear a good tune? But most importantly, music is an important part of any festival experience. Music is the soundtrack to the festival. If you get this part wrong, you will be missing out on a big part of the fun. So, what are the things you need to consider when choosing a festival song? Here are the three things to consider.",
      content:
        "Música es un importante parte de alguna festival. yo media, quien doesn’t querer a oír un bueno melodía? pero más importantly, música es un importante parte de alguna festival experiencia. música es el soundtrack a el festival. Si tú obtener esta parte incorrecto, tú será ser desaparecido fuera en un grande parte de el divertido. asi que, qué son el cosas tú necesitar a considerar cuando choosing un festival canción? aquí son el Tres cosas a considerar",
      language: "spanish",
      difficulty: 100,
      topic: "Music",
    }),
    Prompt.create({
      title: "Sports",
      key: "Loose ball nothing but net nothing but net beep test school semester ball four take a walk header alleyoop, nothing but net nothing but net bowledem awww ref. Loose ball tryouts loose ball goal trust our processes, line break clutch play field hockey awww ref theyre going upstairs what a hit win lose or draw. Corner what a hit game of two halves loose ball clutch play what a hit, red card back line beep test rolling maul semester.",
      content:
        "Suelto pelota nada pero net nada pero net beep prueba colegio semester pelota las cuatro tomar un caminar header alleyoop, nada pero net nada pero net bowledem awww ref.  Suelto pelota tryouts suelto pelota goal confianza nuestra processes, línea descanso embrague jugar campo hockey awww ref theyre yendo piso de arriba qué un golpear ganar perder o dibujar.  Esquina qué un golpear juego de dos halves suelto pelota embrague jugar qué un golpear, rojo tarjeta espalda línea beep prueba rolling maul semester",
      language: "spanish",
      difficulty: 200,
      topic: "Sports",
    }),
    Prompt.create({
      title: "Business I",
      key: "Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.",
      content:
    ...
    Prompt.create({
      title: "Business II",
      key: "Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring.",
      content:
    ...
    Prompt.create({
      title: "Business III",
      key: "Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.",
      content:
    ...
    Prompt.create({
      title: "Politics I",
      key: "In the works of Pynchon, a predominant concept is the distinction between creation and destruction. But an abundance of situationisms concerning structural theory exist. Sartre uses the term ‘objectivism’ to denote a postcultural paradox.",
      content:
        "En la obra de Pynchon, un concepto predominante es la distinción entre creación y destrucción. Pero abundan los situacionismos sobre existe teoría estructural. Sartre usa el término “objetivismo” para denotar una paradoja poscultural.",
      language: "spanish",
      difficulty: 300,
      topic: "Politics",
    }),
    ...
    Prompt.create({
      title: "Politics III",
      key: "In a sense, if textual narrative holds, we have to choose between conceptualist neocapitalist theory and capitalist subpatriarchialist theory. The subject is interpolated into a capitalist theory that includes consciousness as a reality.",
      content:
